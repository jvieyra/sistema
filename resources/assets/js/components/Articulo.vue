          ...
          <div class="form-group row">
            <div class="col-md-6">
              <div class="input-group">
               <!--Directiva model se conecta reactivamente con vue-->
          ...
          <table class="table table-bordered table-striped table-sm">
              ...
              <tbody>
                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                    ...
                    <td>
                      <div class="" v-if="articulo.condicion">
        ...
        <div class="modal-dialog modal-primary modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" @click="registrarArticulo()" v-if="tipoAccion==1" class="btn btn-primary">Guardar</button>
                <button type="button" @click="actualizarArticulo()" v-if="tipoAccion==2" class="btn btn-primary">Actualizar</button>
            </div>
        </div>
              <!-- /.modal-content -->
          </div>
    ...
    export default {
      ...
      methods:{
        ...
        desactivarArticulo(id){
          ...
          swal({
            ...
            if (result.value) {
              ...
              swal(
                'Sin cambios',
                'No se realizo ningun moviemiento en la base de datos',
                'error'
              )
            }
          })
        ...
        validarArticulo(){
          ...
          if(!this.nombre){
            this.errorMostrarMsjArticulo.push('El nombre de la articulo no puede estar vacio');
          }
          if(!this.stock){
            this.errorMostrarMsjArticulo.push('El stock del articulo debe ser un numero y no puede estar vacio');
          }
          if(!this.precio_venta){
            this.errorMostrarMsjArticulo.push('El precio de venta del articulo debe ser un numero y no puede estar vacio');
          }
