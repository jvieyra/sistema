        ...
        <template v-else-if="listado==0">
          ...
          <div class="form-group row border">
            <div class="col-md-9">
              <div class="form-group">
                ...
                <!--Implementacion de v-select-->
                <v-select :on-search="selectCliente" 
                           label="nombre" :options="arrayCliente"
                           placeholder="Buscar Proveedores..." :onChange="getDatosCliente">
          ...
          <div class="form-group row">
            <div class="col-md-12">
              ...
              <button class="btn btn-primary" @click="registrarVenta()">Registrar Venta</button>
            </div>
          </div>
        </div>
        </template>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      activarUsuario(id){
          swal({
            title: 'Estas seguro de activar esta usuario?',
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
