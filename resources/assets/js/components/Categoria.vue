          ...
          <table class="table table-bordered table-striped table-sm">
              ...
              <tbody>
                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                    ...
                    <td>
                      <div class="" v-if="categoria.condicion">
        ...
        <div class="modal-dialog modal-primary modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" @click="registrarCategoria()" v-if="tipoAccion==1" class="btn btn-primary">Guardar</button>
                <button type="button" @click="actualizarCategoria()" v-if="tipoAccion==2" class="btn btn-primary">Actualizar</button>
            </div>
        </div>
              <!-- /.modal-content -->
          </div>
