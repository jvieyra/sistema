    ...
    if($buscar == ''){
      $ventas = Venta::join('personas','ventas.idcliente','=','personas.id')
        ...
        ->select('ventas.id','ventas.tipo_comprobante',
                'ventas.serie_comprobante','ventas.num_comprobante','ventas.fecha_hora',
                'ventas.impuesto','ventas.total','ventas.estado','personas.nombre',
                'users.usuario')
    ...
    $venta = Venta::join('personas','ventas.idcliente','=','personas.id')
                ...
                ->select('ventas.id','ventas.tipo_comprobante',
                        ...
                        'ventas.impuesto','ventas.total','ventas.estado','personas.nombre','personas.tipo_documento',
                         'personas.num_documento','personas.direccion','personas.email','personas.telefono',
                        'users.usuario')
                ->where('ventas.id','=',$id)
                ->orderBy('ventas.id','desc')->take(1)->get();
